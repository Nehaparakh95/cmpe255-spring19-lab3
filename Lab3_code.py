...
def load_data():
    ...
    data_labels = []
    with open(
            "C:/Users/Gautam/Desktop/2nd semester/255/cmpe255-spring19-master/cmpe255-spring19-master/lab3/pos_tweets.txt",
            encoding="utf-8") as f:
        for i in f:
            data.append(i)
    ...
    with open(
            "C:/Users/Gautam/Desktop/2nd semester/255/cmpe255-spring19-master/cmpe255-spring19-master/lab3/neg_tweets.txt",
            encoding="utf-8") as f:
        for i in f:
            data.append(i)
